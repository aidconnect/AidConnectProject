      ...
      <div className="stats">
        <div className="users">
          {data1 && (
            <div className="ngo">
              <h1>
                {data1.data.id_count}&nbsp;<div className="user">NGOs</div>
              </h1>
            </div>
          )}
          {data2 && (
            <div className="donor">
              <h1>
                {data2.data.id_count}&nbsp;<div className="user">Donors</div>
              </h1>
            </div>
          )}
          {data3 && (
            <div className="needy">
              <h1>
                {data3.data.id_count}&nbsp;
                <div className="user">Beneficiaries</div>
              </h1>
            </div>
          )}
          {data4 && (
            <div className="service">
              <h1>
                {data4.data.id_count}&nbsp;<div className="user">Services</div>
              </h1>
            </div>
          )}
        </div>
        ...
        {data5 && (
          <div className="campaign">
            <h1>
              {data5.data.id_count}&nbsp;<div className="user">Successful Campaigns</div>
            </h1>
          </div>
        )}
        ...
        {data6 && (
          <div className="donations">
            <h1>
              {data6.data.id_count}&nbsp;
              <div className="user">Verified donations</div>
            </h1>
          </div>
        )}
        ...
        <div className="numbers">
          {data7 && (
            <div className="total">
              <h1>
                {(data7.data.id_count ?? 0).toFixed(6)}&nbsp;
                <div className="user">ETH raised</div>
              </h1>
            </div>
          )}
          {data5 && data8 && (
            <div className="completion">
              <h1>
                {isNaN((data8.data.id_count / data5.data.id_count) * 100)
                  ? 0
                  : ((data8.data.id_count / data5.data.id_count) * 100).toFixed(
                      2
                    )}
                <div className="user">% Completion rate</div>
              </h1>
            </div>
          )}
        </div>
